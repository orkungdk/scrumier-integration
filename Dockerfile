...
VOLUME /tmp
ARG DEPENDENCY=/services/integration/target/dependency
...
ENTRYPOINT ["java","-cp","app:app/lib/*", "tr.com.ogedik.integration.IntegrationApplication"]
##############################################################
# You can contact me via email or create an issue on github. #
# Email: orkungedik90@gmail.com                              #
# Github: https://github.com/orkungdk/integration/issues  #
##############################################################
